...
TODO 5: Remove resume and use player instead.
TODO 5: icons max 48x48
TODO 5: Read icon and rezize it to icon size befor put in map...
TODO 5: Change playlist progressbar to seekbar
TODO 5: Handle failed download/timeout:
	DownloadService.java:158
	Util.downloadFile Util.java:107
	The operation timed out.
	DownloadQueueList
	Attempted to add application window with unknown token
	is your activity running?
	DownloadQueueList.java:260
	Util.showdialog, Util.java:60
	Probably show dialog from Util thread for exception?
TODO 5: downloading icon in status bar and for each feeditem during download.
TODO 5: Problem in BitmapFactory.decodeFile()
TODO 5: Log Runtime.freeMemory() in thread preiodically.
TODO 5: DDMS-Heap-View never broke the 16MB barrier
TODO 5: Maximum icon size: x*y. Scale down during after download to sd.
TODO 5: Refresh all feeds does not work
TODO 5: show error during import
TODO 5: check process memory consumption
TODO 5: FeedList downlaod bug:
