...
public class FileItem {
	...
	public final static int ID3_TITLE = 4;
	public final static int ID3_ARTIST = 5;
	public final static int ID3_ALBUM = 6;
	public final static int ID3_YEAR = 7;
	public final static int NOTES = 8;
	public final static int COUNTER = 9;
